...
import {formItemLayout, formLayout, LoginButton, RegisterButton, tailFormItemLayout, Title} from './Register.styles';
...
type PropsType = {
    ...
    onFinish: (values: { login: string, password: string, fullName: string, dateOfBirth: string, position: string }) => void
    registerForm: RegisterFormType
    registerIsLoading: boolean
    disabledDate: (current: moment.Moment) => boolean
};

const Register: FC<PropsType> = (props: PropsWithChildren<PropsType>) => {
                ...
                >
                    ...
                    <Form.Item
                        ...
                        rules={[{required: true, message: 'Please input your nickname'},
                            {type: 'string', min: minLengthLogin, message: `Min length is ${minLengthLogin}`},
                            {pattern: /^[A-z-0-9-А-яЁё]*$/, message: `Don't use whitespace or symbols`}]}
                    >
                    ...
                    <Form.Item
                        ...
                        rules={[{required: true, message: 'Please input your password'},
                            {type: 'string', min: minLengthPassword, message: `Min length is ${minLengthPassword}`},
                            {pattern: /^[A-z-0-9]*$/, message: `Don't use whitespace or symbols`}]}
                    >
                    ...
                    <Form.Item
                        ...
                        rules={[{required: true, message: 'Please input your full name'},
                            {pattern: /^[A-zА-яЁё\s]*$/, message: `Don't use symbols or numbers`}]}
                    >
