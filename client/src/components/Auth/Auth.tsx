        ...
        <Row>
            <Col {...loginLayout}>
                ...
                >
                    <Row>
                        <Col {...titleLayout}>
                    <Title>Manage your incidents <DiffFilled style={{color: '#b07fb9'}}/> </Title>
                        </Col>
                        <Col {...formLayout}>
                    <Form.Item
                        label="Login"
                    ...
                    >
                        <Input placeholder="Enter your login" prefix={<UserOutlined />}/>
                    </Form.Item>
                    <Form.Item
                        label="Password"
                        name="password"
                    ...
                    >
                        <Input.Password placeholder="Enter your password" prefix={<KeyOutlined />}/>
                    </Form.Item>
                    <Form.Item {...tailLayout}>
                            ...
                            <Row>
                                <Col span={12} offset={6}>
                                    <RegisterButton>
                            <NavLink to={'/register'} style={{color: 'black'}} onClick={props.fromRegisterReset}>Register</NavLink>
                                    </RegisterButton>
                                    </Col>
                            </Row>
                        </Col>
